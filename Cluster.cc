...
Cluster::Cluster(const Cluster & old) {
...
void Cluster::copy_variables(const Cluster & old)
{
   z_min = old.z_min;
   z_max = old.z_max;
   dz = old.dz;
...
void Cluster::copy_pointers_deep(const Cluster &old) 
{
...
void Cluster::init(double r_min_, double r_max_, double dr_, 
...
void Cluster::init( double x_min_, double x_max_, double dx_, 
...
void Cluster::print() {
  ...
  cout<<"Cluster: n_spatial_dimensions="<<n_spatial_dimensions<<endl;
...
Cluster & Cluster::operator = (const Cluster & old) {
